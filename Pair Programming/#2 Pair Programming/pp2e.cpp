/*File: pp2e.cpp
	...
	This program takes the users inputted marriage status and outputs a message based on that status
*/
...
int main()
{
	...
	cin >> marriageStatus; //Applying the users inputted Marriage Status to the variable
